import type { ChartPoint } from '../stocks.types'
import { StockPriceRow } from './stocks-cache.types'

/**
 * Maps cached SQLite price rows into the chart format expected by Recharts.
 */
export function mapCachedPricesToChartData(rows: StockPriceRow[]): ChartPoint[] {
